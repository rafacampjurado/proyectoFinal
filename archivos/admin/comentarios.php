...
require '../views/comentariosView.php';
...
if (isset($_SESSION['usuario'])) {
    ...
    if ($_SESSION['usuario']->getRol() == 'admin') {
        ...
        $idComentario = (isset($_GET['id']) ? $_GET['id'] : null); // Recogemos el ID si procede
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                if ($accion_editar) {
                                    ...
                                    echo $controlador->adminEditarComentario($idComentario);

                                } else if ($accion_listar) {

                                    echo $controlador->listarComentarios();
