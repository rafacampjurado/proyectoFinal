...
if (isset($_SESSION['usuario'])) {
    ...
    if ($_SESSION['usuario']->getRol() == 'admin') {
        ...
        $idProducto = (isset($_GET['id']) ? $_GET['id'] : null); // Recogemos el ID si procede
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                if ($accion_nuevo) {
                                    ...
                                    echo $controlador->nuevoProducto();

                                } else if ($accion_editar) {

                                    echo $controlador->editarProducto($idProducto);

                                } else if ($accion_listar) {

                                    echo $controlador->listadoProductos();
